...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    const staticRoutes: MetadataRoute.Sitemap = ([
        ...
        { url: `${BASE_URL}/etkinlikler`, priority: 0.9, changeFrequency: 'daily' as const },
        { url: `${BASE_URL}/kurslar`, priority: 0.8, changeFrequency: 'weekly' as const },
        { url: `${BASE_URL}/kulupler`, priority: 0.8, changeFrequency: 'weekly' as const },
        { url: `${BASE_URL}/takvim`, priority: 0.7, changeFrequency: 'daily' as const },
        { url: `${BASE_URL}/mekanlar`, priority: 0.6, changeFrequency: 'weekly' as const },
        { url: `${BASE_URL}/hakkimizda`, priority: 0.5, changeFrequency: 'monthly' as const },
        { url: `${BASE_URL}/iletisim`, priority: 0.5, changeFrequency: 'monthly' as const },
    ] as MetadataRoute.Sitemap).map((r) => ({ ...r, lastModified: new Date() }));
