                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-card border border-border p-6 rounded-2xl shadow-xl flex items-center gap-4">
                                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center text-primary">
                                    <Users className="w-6 h-6" />
                                </div>
                                <div>
                                    <span className="block text-2xl font-bold text-foreground">5000+</span>
                                    <span className="text-sm text-muted-foreground">Mutlu Katılımcı</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <div className="space-y-4 text-muted-foreground leading-relaxed">
                                    <p>
                                        <strong className="text-foreground">Sivas Etkinlikleri</strong>, şehrin dinamik yapısını dijital dünyayla buluşturan, kültür ve sanat tutkunlarını bir araya getiren modern bir topluluk platformudur.
                                    </p>
                                    <p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div className="bg-card/50 border border-border p-5 rounded-xl hover:border-primary/30 transition-colors group">
                                    <MapPin className="w-8 h-8 text-primary mb-3 group-hover:scale-110 transition-transform" />
                                    <h3 className="font-bold text-foreground mb-1">Yerel Rehber</h3>
                                    <p className="text-sm text-muted-foreground">Sivas'ın her köşesindeki etkinliklerden anında haberdar olun.</p>
                                </div>
                                <div className="bg-card/50 border border-border p-5 rounded-xl hover:border-primary/30 transition-colors group">
                                    <Heart className="w-8 h-8 text-primary mb-3 group-hover:scale-110 transition-transform" />
                                    <h3 className="font-bold text-foreground mb-1">Tutkuyla Bağlı</h3>
                                    <p className="text-sm text-muted-foreground">Kültür ve sanata olan sevgimizle en nitelikli içerikleri sunuyoruz.</p>
                                </div>
                            </div>
                        </div>
                    </div>
