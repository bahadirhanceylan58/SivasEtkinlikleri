        ...
        <main className="min-h-screen flex flex-col bg-black">
            ...
            <section className="relative py-20 overflow-hidden">
                ...
                <div className="container mx-auto px-4 text-center relative z-10">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 animate-slideInUp">
                        Topluluklar & Kulüpler
                    </h1>
                    <p className="text-gray-400 text-lg max-w-2xl mx-auto mb-8 animate-slideInUp" style={{ animationDelay: '0.1s', opacity: 0, animationFillMode: 'forwards' }}>
                        Sivas'taki aktif öğrenci kulüpleri ve sosyal topluluklar. İlgi alanınıza uygun bir gruba katılın!
                    </p>

                    {/* Statistics */}
                    {!loading && clubs.length > 0 && (
                        <div className="flex items-center justify-center gap-8 md:gap-12 mt-8 animate-fadeIn" style={{ animationDelay: '0.2s', opacity: 0, animationFillMode: 'forwards' }}>
                            <div className="text-center">
                                <div className="text-3xl md:text-4xl font-bold text-primary mb-1">{clubs.length}</div>
                                <div className="text-sm text-gray-400">Aktif Kulüp</div>
                            </div>
                    ...
                    <Link href="/kulup-basvuru">
                        <button className="mt-8 px-6 py-3 bg-primary hover:bg-primary-hover text-black font-bold rounded-xl transition-all shadow-glow hover:shadow-glow-lg transform hover:scale-105 flex items-center gap-2 mx-auto animate-bounceIn" style={{ animationDelay: '0.3s', opacity: 0, animationFillMode: 'forwards' }}>
                ...
                <div className="container mx-auto px-4">
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                            {[1, 2, 3, 4, 5, 6].map((i) => (
                                <div key={i} className="glass-strong p-6 rounded-2xl border border-white/10 animate-pulse">
                        ...
                        <div className="text-center py-20">
                            ...
                            <h3 className="text-2xl font-bold text-white mb-2">Henüz Kulüp Yok</h3>
                            ...
                            {clubs.map((club, index) => {
                                ...
                                return (
                                    <Link
                                        ...
                                        className="block h-full animate-slideInUp"
                                        style={{
                                    ...
                                    >
                                        <div className={`group relative h-full p-6 rounded-2xl border ${config.border} glass-strong transition-all duration-300 hover:scale-[1.02] hover:-translate-y-1 overflow-hidden`}>
                                            ...
                                            <div className="relative z-10 flex flex-col h-full">
                                                ...
                                                <div className="flex items-start justify-between mb-4">
                                                    {/* Club Logo/Icon */}
                                                    <div className={`w-16 h-16 rounded-2xl bg-white/5 flex items-center justify-center ${config.icon} group-hover:scale-110 transition-transform duration-300`}>
                                                        {club.logo ? (
                                                            <Image
                                                                src={club.logo}
                                                                alt={club.name}
                                                ...
                                                <div className="flex items-center gap-2 text-gray-400 text-sm mb-4">
                                                    ...
                                                    <span className="font-medium text-white">{club.memberCount || 0}</span>
                                                    <span>aktif üye</span>
                                                ...
                                                {/* Action Button */}
                                                <button
                                                    className="w-full bg-white/5 hover:bg-primary hover:text-black text-white font-semibold py-3 rounded-xl transition-all border border-white/10 hover:border-primary group-hover:shadow-glow"
                                                    onClick={(e) => {
                                                        e.preventDefault();
                                                        // Handle join action
                                                    }}
